        ...
        <>
            ...
            >
                <div className="relative w-full my-6 mx-auto max-w-sm">
                    {/*content*/}
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[30rem] bg-white outline-none focus:outline-none dark:bg-[#11171D]">
                        {/*header*/}
                        ...
                        <div className="relative p-4 flex-auto">
                            <h1 className='text-xl font-bold dark:text-gray-200'>Please read the information below before you proceed to delete your account</h1>
                            <p className="my-2 text-blueGray-500 text-lg leading-relaxed dark:text-gray-200">
                            ...
                            <p className="my-2 text-blueGray-500 text-lg leading-relaxed dark:text-gray-200">Enter your User Id below and then procced to delete your account</p>
                        </div>
                        <form className="flex items-center w-full my-2">
                            ...
                            <div className="md:w-3/4">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 dark:bg-gray-200" id="inline-full-name" type="text" name='userId' onChange={onChange} value={userId} />
                            </div>
