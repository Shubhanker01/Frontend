...
export default function UpdateUsernameModal(props) {
    ...
    return (
        <>
            ...
            >
                <div className="relative w-[20rem] my-6 mx-auto bg-stone-100 rounded-xl dark:bg-gray-800">
                    ...
                    <form className="w-full m-[0px_auto]">
                        <div className="md:flex md:items-center my-[2rem] mx-[2rem]">
                            <div className="py-2">
                                <label className="block text-gray-700 font-bold md:text-right mb-1 md:mb-0 pr-2 text-md dark:text-gray-200" htmlFor="inline-full-name">
                                    Old Username
                                </label>
                            </div>
                            <div className="md:w-1/2">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-2 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 text-md" id="inline-full-name" type="text" value={props.name} readOnly={true}/>
                            </div>
                        </div>
                        <div className="md:flex md:items-center my-[2rem] mx-[2rem]">
                            <div className="py-2">
                            ...
                            <div className="md:w-1/2">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-2 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" name='name' value={update.name} onChange={onChange} />
                            </div>
                        </div>
