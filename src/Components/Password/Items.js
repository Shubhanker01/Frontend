    ...
    return (
        <>
            <div className="rounded overflow-hidden shadow-lg w-[300px] bg-blue-300 dark:bg-[#696969] transform motion-safe:hover:scale-110 transition ease-in-out duration-300">
                <div className='w-full bg-indigo-200 dark:bg-[#363636] py-2 h-[80px]'>
                ...
                <div className='h-[55px] grid grid-cols-2 my-2'>
                    <div className="px-2 dark:text-[#ffffff] w-[170px]">
                        <div className="font-bold mb-2">{props.title.length >= 15 ? props.title.slice(0, 15) + ".." : props.title}</div>
                    ...
                    <div className='flex justify-end px-2 mt-[15px]'>
                        <button onClick={showHideDetails} className='mx-[2px]'>{hideDetails ? <img src="https://img.icons8.com/material-outlined/32/000000/visible--v1.png" className='dark:invert' /> : <img src="https://img.icons8.com/external-tal-revivo-regular-tal-revivo/32/000000/external-hide-feature-with-eye-crossed-shape-button-text-regular-tal-revivo.png" className='dark:invert' />}</button>
                        <button onClick={openEditModal} className='mx-[2px]'><img src="https://img.icons8.com/ios-glyphs/32/000000/edit--v1.png" className='dark:invert' /></button>
