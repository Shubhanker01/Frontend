                        ...
                        <div className="flex flex-col w-full mt-3">
                            <div className='mt-2'>
                                <NavLink className="flex items-center w-full h-[3.5rem] rounded active:bg-blue-700 transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300" activeClassName='bg-slate-900 dark:bg-[#181818]' to={`/main-app/${id}`} >
                                    <img src="https://img.icons8.com/ios-filled/48/ffffff/password.png" className='px-2 py-2 h-[32px] w-[32px]' alt=''/>
                                    <span className="ml-2 mr-2 text-sm font-medium">Password</span>
                                </NavLink>
                            </div>
                            
                            <div className='mt-2'>
                                <NavLink className="flex items-center w-full h-[3.5rem]  rounded transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300" to={`/bankdetails/${id}`} activeClassName='bg-slate-900 dark:bg-[#181818]'>
                                    <img src="https://img.icons8.com/external-smashingstocks-glyph-smashing-stocks/48/ffffff/external-bank-web-smashingstocks-glyph-smashing-stocks.png" className='px-2 py-2 h-[32px] w-[32px]' alt=''/>
                                    <span className="ml-2 mr-2 text-sm font-medium">Bank Details</span>
                                </NavLink>
                            </div>
                            <div className='mt-2'>
                                <NavLink className="flex items-center w-full h-[3.5rem]  rounded transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300" to={`/card-details/${id}`} activeClassName='bg-slate-900 dark:bg-[#181818]'>
                                    <img src="https://img.icons8.com/external-photo3ideastudio-solid-photo3ideastudio/48/ffffff/external-credit-card-food-delivery-photo3ideastudio-solid-photo3ideastudio.png" className='px-2 py-2 h-[32px] w-[32px]' alt=''/>
                                    <span className="ml-2 mr-2 text-sm font-medium">Card Details</span>
                                </NavLink>
                            </div>

                            <div className='mt-2'>
                                <NavLink className="flex items-center w-full h-[3.5rem] rounded transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300" to={`/settings/${id}`} activeClassName='bg-slate-900 dark:bg-[#181818]'>
                                    <img src="https://img.icons8.com/material-rounded/48/ffffff/settings.png" className='px-2 py-2 h-[32px] w-[32px]' alt=''/>
                                    <span className="ml-2 mr-2 text-sm font-medium">Settings</span>
                                </NavLink>
                            </div>
