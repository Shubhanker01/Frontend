...
export default function ViewModal(props) {
    ...
    const [editDetails, setEditDetails] = useState({ title: props.item.title, cardName: props.item.cardName, cardType: props.item.cardType, number: props.item.number, securityCode: props.item.securityCode })
    const onChange = (e) => {
                ...
                <div className="relative w-[37rem] h-[32rem] my-3 mx-auto max-w-6xl bg-stone-100 rounded-xl dark:bg-[#11171D]">
                    ...
                    <form className="w-full m-[10px_auto]">
                        ...
                        <div className="md:items-center my-[1rem] mx-[2rem]">
                            ...
                            <div className="md:w-full">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 w-full dark:bg-gray-200" type='text' value={editDetails.cardName} onChange={onChange} name='cardName'></input>
                            </div>
                        </div>
                        <div className="md:items-center my-[1rem] mx-[2rem]">
                            <div className="md:w-1/3">
                            ...
                            <div className="md:w-full">
                                <select className="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 w-full dark:bg-gray-200" value={editDetails.cardType} onChange={onChange} name='cardType'
                                >
                        ...
                        <div className="md:items-center my-[1rem] mx-[2rem]">
                            ...
                            <div className="md:w-full">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 w-full dark:bg-gray-200" type='text' value={editDetails.number} onChange={onChange} name='number'></input>
                            </div>
                        </div>
                        <div className="md:items-center my-[1rem] mx-[2rem]">
                            <div className="md:w-1/3">
                            ...
                            <div className="md:w-full">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 w-full dark:bg-gray-200" type='text' value={editDetails.securityCode} onChange={onChange} name='securityCode'></input>
                            </div>
                        </div>
                    </form>
